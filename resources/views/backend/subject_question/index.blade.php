        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-2" style="padding-top: 5px;padding-bottom: 5px;">
                     @if(canViewRoute('user.create','route'))  
                     <a href="{{ route('admin.subject.question.create',$slug) }}" class="btn btn-block btn-outline-success">
                     Add New </a>
                     @endif
                 </div>
             </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if(canViewRoute('admin.subject.question.edit','route'))
                                    <a href="{!! route('admin.subject.question.edit',[$slug,$subject_question->id]) !!}" class="btn btn-sm btn-info">
                                        <i class="fa fa-edit" title="Edit"></i>
                                    </a>
                                    @endif
                                    @if(canViewRoute('admin.subject.section.destroy','route'))
                                    <a href="{!! route('admin.subject.question.destroy',[$slug,$subject_question->id]) !!}" class="btn btn-sm btn-danger"
