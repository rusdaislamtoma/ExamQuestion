...
<div class="card card-info card-outline">
    ...
    <form action="{{ route('admin.subject.question.update',[$subject->slug,$subjectQuestion->id]) }}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="card-body">
            <div class="row">
                @include('backend.subject_question._form2')
            </div>
            <div class="row" style="margin-top:10px;">
                <div class="col-md-2 offset-md-5">
                    <input type="submit" value="Update" class="btn btn-success pull-left">
                    <a href="{!! route('admin.subject.question.index',$subject->slug) !!}" class="btn btn-danger ml-2"
