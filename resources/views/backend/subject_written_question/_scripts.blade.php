...
$(document).ready(function(){
    $("#add_new_question").click(function(){
        ...
        $('#question').append('\n' +
            ...
            '                    <textarea  name="question[]" rows="1" cols="50" class="form-control border border-info" placeholder="Enter Question"\n' +
            '                                required></textarea>\n' +
            '          </div>\n' +
            '    </div>\n' +
            '\n' +
            ...
            '            <div class="form-group" >\n' +
            '                <label>Mark:</label>\n' +
            '                <input type="number" value="" name="mark'+i+'[]" step="0.01" class="form-control border border-info" placeholder="Enter mark" >\n' +
            '            </div>\n' +
            '    </div>\n'+
            '  <div class="col-md-3" style="float: left">\n' +
            '            <div class="form-group" >\n' +
