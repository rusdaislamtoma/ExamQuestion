...
<div class="card card-info card-outline">
    ...
    <form action="{{ route('admin.subject.section.update',[$subject->slug,$subjectSection->slug,$subjectSection->id]) }}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="card-body">
            <div class="row">
            ...
            <div class="row" style="margin-top:10px;">
                <div class="col-md-2 offset-md-5">
                    ...
                    <a href="{!! route('admin.subject.section.index',$subject->slug) !!}" class="btn btn-danger ml-2"
