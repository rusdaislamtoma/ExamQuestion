        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-2" style="padding-top: 5px;padding-bottom: 5px;">
                        @if(canViewRoute('user.create','route'))
                            <a href="{{ route('admin.make.written_question.create',$slug) }}" class="btn btn-block btn-outline-success">
                                Make Question </a>
                        @endif
                    ...
                    <div class="col-md-2" style="padding-top: 5px;padding-bottom: 5px;">
                     @if(canViewRoute('user.create','route'))  
                     <a href="{{ route('admin.print.make_written_question',$slug) }}" class="btn btn-block btn-outline-success">
                     Print Question </a>
                     @endif
                    </div>
                 </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if(canViewRoute('admin.make.written_question.again','route'))
                                    <a href="{!! route('admin.make.written_question.again',[$slug,$subject_question->code_id,$subject_question->subject_section_id]) !!}"
                                       class="btn btn-sm btn-info">
                                        <i class="fa fa-edit" title="Edit">Again Generate</i>
                                    </a>
                                    @endif
                                    @if(canViewRoute('admin.make.written_question.destroy','route'))
                                    <a href="{!! route('admin.make.written_question.destroy',[$slug,$subject_question->code_id]) !!}" class="btn btn-sm btn-danger"
