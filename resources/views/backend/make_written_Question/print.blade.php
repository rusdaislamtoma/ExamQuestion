        ...
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <p>Time: {{ $subject->written_time }} Hour</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <p class="text-center">(Answer  of  any   {{ $total_question - 1 }}  questions) </p>
                        </div>
                    </div>
                </div>
                <hr>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    @php
                                        ...
                                        $mark = json_decode($question->mark);
                                    @endphp
                                    @foreach($options as $key=>$option)
                                       <div>&nbsp;&nbsp;&nbsp;&nbsp;
                                           {{ $array[$key] }}.&nbsp;{{ $option }} &nbsp;&nbsp;&nbsp;  {{ '('.$mark[$key].')' }}
                                       </div>
                                    @endforeach
                                </div>
                            </div>
